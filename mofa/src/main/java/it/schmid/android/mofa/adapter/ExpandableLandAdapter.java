...
public class ExpandableLandAdapter extends BaseExpandableListAdapter{
	...
	private Map<Long,WorkVQuarter> hashSelQuarters;
	private WorkVQuarter mWorkVQuarter;
	private Work mcurWork;
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if( v == null ){
			...
			holder.selected.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton buttonView,	boolean isChecked) {
					...
					if ((isChecked == false) && (hashSelQuarters.containsKey(element.getId().longValue()))){ // we uncheck a quarter, which is in the hash -> remove it
					...
					if ((isChecked == true) && (!hashSelQuarters.containsKey(element.getId().longValue()))){ 
		...
		ViewHolder mholder = (ViewHolder) v.getTag();
	     ...
	     if (hashSelQuarters.containsKey(vquarter.getId().longValue())){
	...
	//	ViewHolderParent mholder = (ViewHolderParent) v.getTag();
		...
		if ((groupChecked==true)||(allSubItemsSelected(group)==true)){
